...
#if CHIP_WS63
    IoTGpioInit(IOT_IO_NAME_GPIO_15); /* GPIO15 */
    IoSetFunc(IOT_IO_NAME_GPIO_15, IOT_IO_FUNC_GPIO_15_I2C1_SDA); /* GPIO13 SDA */
    IoTGpioInit(IOT_IO_NAME_GPIO_16);  /* GPIO16 */
    IoSetFunc(IOT_IO_NAME_GPIO_16, IOT_IO_FUNC_GPIO_16_I2C1_SCL); /* GPIO16 SCL */

    IoTI2cInit(OLED_I2C_IDX, OLED_I2C_BAUDRATE); /* baudrate: 400kbps */
#else
